            ...
            <div className='vestify'>
                ...
                <div className='invest_card'>
                    <div >
                        ...
                        <h3 data-aos="fade-up">Flexible investment options</h3>
                        <p data-aos="fade-down">Choose from a variety of plans designed to fit your financial goals, whether you prefer short-term gains or long-term growth.</p>
                    </div>
                    <div>
                        <div className='invest_card2' data-aos="fade-up" data-aos-duration="2000">
                            <img src="src/img/investifyTwo.svg" alt="" />
                        </div>
                        <h3 data-aos="fade-up">Competitive returns</h3>
                        <p data-aos="fade-down">Benefit from high-yield investment opportunities that maximise your returns, helping you reach your financial targets faster.</p>
                    </div>
                    <div>
                        <div className='invest_card3' data-aos="fade-up" data-aos-duration="3000">
                            <img src="src/img/investifyThree.png" alt="" />
                        </div>
                        <h3 data-aos="fade-up">Expertly curated investments</h3>
                        <p data-aos="fade-down">Invest in carefully selected portfolios managed by experts to optimise your returns with minimal risk.</p>
                    </div>
                ...
                <div className='vestify_bottom'>
                    ...
                    <div className='vestify_bottom_text'>
                        <h1 data-aos="fade-up">Meet our <br />Saver of the Month</h1>
                        <p data-aos="fade-up">Every month, we put the spotlight on one saver. We ask them about their<br/> savings culture and how Piggyvest has helped them achieve their goals.</p>
                    </div>
                </div>
            </div>
        </>
